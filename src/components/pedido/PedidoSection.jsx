  ...
  return (
    <section id="pedido" className="py-10 bg-(--c-secundary) relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        <div className="bg-white rounded-[3rem] shadow-xl shadow-(--c-primary)/5 p-8 md:p-12 border border-white/50 backdrop-blur-sm">
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                <span className="flex items-center justify-center w-8 h-8 rounded-full bg-(--c-primary) text-white text-xs font-bold">1</span>
                <h3 className="text-xl font-bold text-(--c-primary) uppercase tracking-wider">¿Cuántos querés llevar?</h3>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <span className="flex items-center justify-center w-8 h-8 rounded-full bg-(--c-primary) text-white text-xs font-bold">2</span>
                  <h3 className="text-xl font-bold text-(--c-primary) uppercase tracking-wider">Elegí los sabores</h3>
                </div>
                {/* Indicador de "cupo" */}
        ...
        <p className="mt-8 text-center text-xs text-(--c-gray) opacity-60">

export default function Footer() {
  return (
    <footer className="bg-[var(--c-primary)] text-white mt-20 border-t border-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-center text-center md:text-left">
          ...
          <div className="space-y-3">
            <h2 className="text-2xl font-black tracking-tighter italic">
              Alfajores <span className="text-white/80">CT</span> 🍪
            </h2>
          ...
          <div className="flex flex-col items-center space-y-4">
             <div className="flex gap-6">
                <a href="#" className="hover:scale-110 transition-transform opacity-80 hover:opacity-100">Instagram</a>
                <a href="#" className="hover:scale-110 transition-transform opacity-80 hover:opacity-100">WhatsApp</a>
             </div>
          ...
          <div className="text-center md:text-right space-y-2">
            ...
            <a 
              href="mailto:info@alfajoresct.com" 
              className="inline-block bg-white text-[var(--c-primary)] px-4 py-2 rounded-lg text-xs font-bold hover:bg-gray-100 transition"
            >
              Contactanos
            </a>
          </div>

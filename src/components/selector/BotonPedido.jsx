export default function BotonPedido({ link }) {
  if (!link) return null;

  return (
    <div className="fixed bottom-6 left-0 right-0 px-4 md:relative md:bottom-0 md:px-0 animate-in slide-in-from-bottom-6 duration-500">
      <a
        href={link}
        target="_blank"
        ...
        className="
          ...
          shadow-[0_10px_20px_-10px_rgba(46,52,88,0.5)]
          hover:shadow-[0_15px_25px_-5px_rgba(46,52,88,0.4)]
          hover:-translate-y-1 active:scale-95
          transition-all duration-300
        "
      >
        {/* Brillo reflectivo interno */}
